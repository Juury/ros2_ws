...
l3xz_openmv_camera_interfaces__srv__GpioSet_Request__create()
{
  ...
  l3xz_openmv_camera_interfaces__srv__GpioSet_Request * msg = (l3xz_openmv_camera_interfaces__srv__GpioSet_Request *)allocator.allocate(sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Request));
  bool success = l3xz_openmv_camera_interfaces__srv__GpioSet_Request__init(msg);
  if (!success) {
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Request__destroy(l3xz_openmv_camera_interfaces__srv__GpioSet_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    l3xz_openmv_camera_interfaces__srv__GpioSet_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence__init(l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  l3xz_openmv_camera_interfaces__srv__GpioSet_Request * data = NULL;

  if (size) {
    data = (l3xz_openmv_camera_interfaces__srv__GpioSet_Request *)allocator.zero_allocate(size, sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = l3xz_openmv_camera_interfaces__srv__GpioSet_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        l3xz_openmv_camera_interfaces__srv__GpioSet_Request__fini(&data[i - 1]);
      }
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence__fini(l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      l3xz_openmv_camera_interfaces__srv__GpioSet_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence * array = (l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence *)allocator.allocate(sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence__init(array, size);
  if (!success) {
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence__destroy(l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence__are_equal(const l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence * lhs, const l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!l3xz_openmv_camera_interfaces__srv__GpioSet_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  l3xz_openmv_camera_interfaces__srv__GpioSet_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    l3xz_openmv_camera_interfaces__srv__GpioSet_Request * data =
      (l3xz_openmv_camera_interfaces__srv__GpioSet_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!l3xz_openmv_camera_interfaces__srv__GpioSet_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          l3xz_openmv_camera_interfaces__srv__GpioSet_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!l3xz_openmv_camera_interfaces__srv__GpioSet_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  l3xz_openmv_camera_interfaces__srv__GpioSet_Response * msg = (l3xz_openmv_camera_interfaces__srv__GpioSet_Response *)allocator.allocate(sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Response));
  bool success = l3xz_openmv_camera_interfaces__srv__GpioSet_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Response__destroy(l3xz_openmv_camera_interfaces__srv__GpioSet_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    l3xz_openmv_camera_interfaces__srv__GpioSet_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence__init(l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  l3xz_openmv_camera_interfaces__srv__GpioSet_Response * data = NULL;

  if (size) {
    data = (l3xz_openmv_camera_interfaces__srv__GpioSet_Response *)allocator.zero_allocate(size, sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = l3xz_openmv_camera_interfaces__srv__GpioSet_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        l3xz_openmv_camera_interfaces__srv__GpioSet_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence__fini(l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      l3xz_openmv_camera_interfaces__srv__GpioSet_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence * array = (l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence *)allocator.allocate(sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence__destroy(l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence__are_equal(const l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence * lhs, const l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!l3xz_openmv_camera_interfaces__srv__GpioSet_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  l3xz_openmv_camera_interfaces__srv__GpioSet_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(l3xz_openmv_camera_interfaces__srv__GpioSet_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    l3xz_openmv_camera_interfaces__srv__GpioSet_Response * data =
      (l3xz_openmv_camera_interfaces__srv__GpioSet_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!l3xz_openmv_camera_interfaces__srv__GpioSet_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          l3xz_openmv_camera_interfaces__srv__GpioSet_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!l3xz_openmv_camera_interfaces__srv__GpioSet_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
