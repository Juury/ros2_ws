...
#ifndef L3XZ_OPENMV_CAMERA_INTERFACES__SRV__DETAIL__GPIO__FUNCTIONS_H_
#define L3XZ_OPENMV_CAMERA_INTERFACES__SRV__DETAIL__GPIO__FUNCTIONS_H_
...
/// Create srv/Gpio message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * l3xz_openmv_camera_interfaces__srv__Gpio_Request__init().
...
/// Destroy srv/Gpio message.
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Gpio_Request__fini()
...
/// Check for srv/Gpio message equality.
/**
...
/// Initialize array of srv/Gpio messages.
/**
...
/// Finalize array of srv/Gpio messages.
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Gpio_Request__fini()
...
/// Create array of srv/Gpio messages.
/**
 * It allocates the memory for the array and calls
 * l3xz_openmv_camera_interfaces__srv__Gpio_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Gpio messages.
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Gpio_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Gpio message array equality.
/**
...
/// Copy an array of srv/Gpio messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * l3xz_openmv_camera_interfaces__srv__Gpio_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_l3xz_openmv_camera_interfaces
...
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Gpio_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_l3xz_openmv_camera_interfaces
...
/**
 * It allocates the memory for the array and calls
 * l3xz_openmv_camera_interfaces__srv__Gpio_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_l3xz_openmv_camera_interfaces
...
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Gpio_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // L3XZ_OPENMV_CAMERA_INTERFACES__SRV__DETAIL__GPIO__FUNCTIONS_H_
