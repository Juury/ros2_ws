...
#include "l3xz_openmv_camera_interfaces/srv/detail/ir__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const l3xz_openmv_camera_interfaces::srv::Ir_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<l3xz_openmv_camera_interfaces::srv::Ir_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Ir_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const l3xz_openmv_camera_interfaces::srv::Ir_Request *>(
...
static size_t _Ir_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Ir_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Ir_Request__callbacks = {
...
static rosidl_message_type_support_t _Ir_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Ir_Request__callbacks,
...
{
  return &l3xz_openmv_camera_interfaces::srv::typesupport_fastrtps_cpp::_Ir_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const l3xz_openmv_camera_interfaces::srv::Ir_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<l3xz_openmv_camera_interfaces::srv::Ir_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Ir_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const l3xz_openmv_camera_interfaces::srv::Ir_Response *>(
...
static size_t _Ir_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Ir_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Ir_Response__callbacks = {
  "l3xz_openmv_camera_interfaces::srv",
  "Ir_Response",
...
static rosidl_message_type_support_t _Ir_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Ir_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &l3xz_openmv_camera_interfaces::srv::typesupport_fastrtps_cpp::_Ir_Response__handle;
}
...
static service_type_support_callbacks_t _Ir__callbacks = {
  "l3xz_openmv_camera_interfaces::srv",
  "Ir",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, l3xz_openmv_camera_interfaces, srv, Ir_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, l3xz_openmv_camera_interfaces, srv, Ir_Response)(),
...
static rosidl_service_type_support_t _Ir__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Ir__callbacks,
...
{
  return &l3xz_openmv_camera_interfaces::srv::typesupport_fastrtps_cpp::_Ir__handle;
}
