...
#ifndef L3XZ_OPENMV_CAMERA_INTERFACES__SRV__DETAIL__RGB__FUNCTIONS_H_
#define L3XZ_OPENMV_CAMERA_INTERFACES__SRV__DETAIL__RGB__FUNCTIONS_H_
...
/// Create srv/Rgb message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * l3xz_openmv_camera_interfaces__srv__Rgb_Request__init().
...
/// Destroy srv/Rgb message.
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Rgb_Request__fini()
...
/// Check for srv/Rgb message equality.
/**
...
/// Initialize array of srv/Rgb messages.
/**
...
/// Finalize array of srv/Rgb messages.
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Rgb_Request__fini()
...
/// Create array of srv/Rgb messages.
/**
 * It allocates the memory for the array and calls
 * l3xz_openmv_camera_interfaces__srv__Rgb_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Rgb messages.
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Rgb_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Rgb message array equality.
/**
...
/// Copy an array of srv/Rgb messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * l3xz_openmv_camera_interfaces__srv__Rgb_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_l3xz_openmv_camera_interfaces
...
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Rgb_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_l3xz_openmv_camera_interfaces
...
/**
 * It allocates the memory for the array and calls
 * l3xz_openmv_camera_interfaces__srv__Rgb_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_l3xz_openmv_camera_interfaces
...
/**
 * It calls
 * l3xz_openmv_camera_interfaces__srv__Rgb_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // L3XZ_OPENMV_CAMERA_INTERFACES__SRV__DETAIL__RGB__FUNCTIONS_H_
